...
class rs:
    ...
    def Zhw(self):
        ...
        self.lb.bind('<Double-Button-1>', self.openurl)
        resp = requests.get('https://www.zhihu.com/api/v3/feed/topstory/hot-lists/total', headers={
    ...
    def Root(self):
        ...
        self.root.call('winico', 'taskbar', 'add', self.icon, '-callback',
                       (self.root.register(self.menuf), '%m', '%x', '%y'), '-pos', 0, '-text', u'热榜')
